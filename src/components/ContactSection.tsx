    ...
    <section id="contact" className="section-padding section-alt">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          {/* Form / Success Card */}
          {success ? (
            <div className="bg-card rounded-2xl border border-border p-8 text-center flex flex-col items-center justify-center space-y-5 min-h-[418px] animate-fade-up">
