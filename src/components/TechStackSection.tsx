...
const categories = [
  {
    title: "Frontend",
    icon: Code2,
    techs: ["React", "Next.js", "TypeScript", "Vite", "Tailwind CSS"],
  },
  {
    title: "Backend",
    icon: Server,
    techs: ["Node.js", "Express.js", "Python (Django/Flask)", "REST API", "JWT"],
  },
  {
    title: "Database",
    icon: Database,
    techs: ["PostgreSQL", "MySQL", "Firebase", "Neon", "Supabase"],
  },
  {
    title: "Mobile",
    icon: Smartphone,
    techs: ["React Native", "Expo Go", "Flutter"],
  },
  {
    title: "Cloud & DevOps",
    icon: Cloud,
    techs: ["Vercel", "Render", "Azure", "Google Cloud"],
  },
  {
    title: "Tools & Testing",
    icon: GitBranch,
    techs: ["Git", "Postman", "Vitest", "ESLint"],
  },
  {
    title: "AI Integration",
    icon: Brain,
    techs: ["OpenAI API", "LangChain", "GitHub Copilot"],
  },
];
